...
/*
  @Deployment(name="index-jboss") @TargetsContainer("jbossas-managed")
  ...
  @Deployment(name="index-weblogic") @TargetsContainer("weblogic")
  public static WebArchive createDeployment2() {
    WebArchive war = ShrinkWrap.create(WebArchive.class,"index-weblogic.war")
            .addAsWebResource("index.html");
    System.out.println(war.toString(true));
    return war;
  }
